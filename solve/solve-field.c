...
static an_option_t options[] = {
    ...
    {'N', "new-fits",    required_argument, "filename", "output filename of the new FITS file containing the WCS header; \"none\" to not create this file"},
     // offline index directory
    {'x', "index-dir",   required_argument, "dirname", "search for index files in the given directory (for offline solving)"},
...
int main(int argc, char** args) {
    ...
    while (1) {
        ...
        case 'N':
            ...
            break;
        case 'x':
            // pass through to astrometry‑engine
