...
def timelapse_with_overlay(constellations: str, stars: str, planets: str, date_of_timelapse: str):
    ...
    movie_out_name = f'requested_overlay_movie'
    movie_out_dir = '/data/cloudcams/cloudcam2025/images'
